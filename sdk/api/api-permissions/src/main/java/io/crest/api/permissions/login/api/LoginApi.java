package io.crest.api.permissions.login.api;
 ...
 */
@Tag(name = "登录")
@ApiSupport(order = 889, author = "Crest")
public interface LoginApi {
    ...
    @PostMapping("/login/platform-login/{origin}")
    ...
    @PostMapping("/login/modify-invalid-password")
