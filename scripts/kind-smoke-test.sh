...
backend_source_image="${CREST_KIND_BACKEND_IMAGE:-crest-core-service:local-check}"
frontend_source_image="${CREST_KIND_FRONTEND_IMAGE:-crest-core-web:local-check}"
backend_runtime_image="${CREST_KIND_BACKEND_RUNTIME_IMAGE:-crest-core-service:${local_image_tag}}"
frontend_runtime_image="${CREST_KIND_FRONTEND_RUNTIME_IMAGE:-crest-core-web:${local_image_tag}}"
