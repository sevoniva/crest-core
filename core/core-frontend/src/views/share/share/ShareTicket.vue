...
const requireTicketChange = val => {
  const url = '/ticket/tickets/enabled'
  const data = {
...
const loadTicketData = () => {
  ...
  const url = `/ticket/page/${resourceId}/${state.paginationConfig.currentPage}/${state.paginationConfig.pageSize}`
