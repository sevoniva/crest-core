...
// 字段归属或图表类型变化后重新计算标签颜色，保持维度/指标识别一致
watch(
...
const beforeClickItem = type => {
  // Element 下拉菜单只透传 command，这里统一封装命令类型
  return {
    type: type
  }
}
