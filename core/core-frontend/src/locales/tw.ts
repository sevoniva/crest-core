export default {
  common: {
    ...
    frontend_commit: '前端 Commit',
    backend_version: '後端版本',
    backend_commit: '後端 Commit',
    version_info_read_failed: '版本資訊讀取失敗',
    exit_system: '退出系統',
  ...
  data_set: {
    ...
    parameter_name: '參數名稱',
    parameter_default_value_label: '參數預設值',
    ...
    export_tasks_successful_go_to: '{count} 個導出任務已成功，前往',
    export_tasks_failed_go_to: '{count} 個導出任務失敗，前往',
    data_set: '資料集',
    view: '圖表',
    organization: '所屬組織',
    download: '下載',
    ...
    expression_required: '表達式不能為空!',
    copy_a_dataset: '複製資料集',
    related_field_required: '關聯欄位不能為空!',
    ...
    rule_condition_required: '規則條件不能為空'
  },
  data_source: {
    ...
    delete_row: '刪除列',
    refresh_data: '刷新資料',
    select_edit_table: '請選擇資料表',
    select_delete_rows: '請選擇要刪除的資料列',
    no_edit_changes: '暫無需要儲存的改動',
    unsaved_edit_confirm: '目前編輯內容尚未儲存，確認放棄改動？',
    ...
    parameter_table_name_exists: '已經存在同名的參數表',
    ...
    data_source_name_placeholder: '請輸入資料來源名稱',
    a_folder_name: '請輸入資料夾名稱',
    data_source: '資料來源',
    the_destination_folder: '請選擇目標資料夾',
    relevant_content_found: '沒有找到相關內容',
    cannot_be_empty: 'SSH主機不能為空',
    ssh_port_required: 'SSH埠不能為空',
    ssh_username_required: 'SSH使用者名稱不能為空',
    ssh_password_required: 'SSH密碼不能為空白',
    ssh_key_required: 'SSH key不能為空',
    to_64_characters: '參數名稱限制2～64字元',
    interface_name_length_limit: '介面名稱限制2～64字元',
  ...
  system: {
    ...
    hour_execution_default: '小時（執行時間：0分0秒）',
    ...
    upload_font_file_required: '請上傳字庫檔案',
    font_name: '字型名稱',
    font_file_label: '字庫檔案',
    ...
    mobile_supports_custom_settings: '預設為{msg} 行動端登入介面，支援自訂設定',
    login_logo: '登入Logo',
    login_logo_size_limit: '登入頁面右側Logo，建議尺寸120*30，支援JPG、PNG、SVG，大小不超過200KB',
    ...
    url_format_error: 'url格式錯誤，請重新輸入',
    ...
    plugin_uninstall_restart_notice: '卸載並重新啟動伺服器之後才能生效',
  ...
  user: {
    ...
    pwd_pattern_error: '8-100位元且至少一位大寫字母、小寫字母、數字、特殊字元',
    ...
    current_user_status_locked: '不能修改目前使用者狀態',
    ...
    data_import_failed_message: '資料導入失敗'
  },
  userimport: {
    buttonText: '批次導入',
    dialogTitle: '批次上傳',
  ...
  datasource: {
    ...
    auth_method: '認證方式',
    passwd: '使用者名稱密碼',
    kerbers_info: '請確保krb5.Conf、Keytab Key，已新增至路徑：/opt/crest/conf',
  ...
  chart: {
    ...
    table_header_description: '表頭說明',
    table_header_description_config: '說明內容',
    table_header_description_height: '說明行高',
    table_header_description_tip:
      '按當前顯示字段填寫說明；字段隱藏或調整順序後，會按字段重新匹配。',
    table_header_description_placeholder: '請輸入說明內容',
    cancel_group: '取消分組',
    ...
    merge_cells: '合併儲存格',
    merge_cells_fields: '合併字段',
    merge_cells_fields_placeholder: '請選擇字段',
    merge_cells_fields_tip:
      '僅支援選擇第一個指標前的維度字段；系統會按上下相鄰且值相同的儲存格縱向合併，後置維度會在前置維度分組內合併。',
    length_limit: '長度限制',
    radar_point: '開啟輔助點',
  ...
  dataset: {
    ...
    sql_variable_limit_2:
      "2、範例: select * from table where $CREST_PARAM{'{'} name = substring('$[PARAM1]',1,5){'}'} and $CREST_PARAM{'{'} name in ($[PARAM2]) {'}'}",
    select_month: '選擇月',
    select_date: '選擇日期',
    select_time: '選擇時間',
    time_year: '日期-年',
    ...
    parse_error:
      'Excel解析失敗，請檢查格式、欄位等資訊。具體參考：https://github.com/sevoniva/Crest',
  ...
  v_query: {
    ...
    required_default_value_empty: '查詢條件為必填項,預設值不能為空',
  ...
  visualization: {
    ...
    outer_params_type_tips1:
      "類型為過濾時，僅支持文字下拉、文字樹、數字下拉；文字樹多級值使用 ' > ' 分隔。",
    ...
    app_name: '應用名稱',
    app_version: '應用版本號',
    app_required_version: 'Crest最低版本號',
    description: '描述',
    new_dataset: '新建數據集',
    ...
    apply_template: '應用模板',
    style_template: '樣式模板',
    import_app_template: '導入應用模板',
    template_file_type_limit: '僅支持 .crest 模板文件',
    template_type_mismatch: '模板類型與當前資源類型不一致',
    import_template_expired: '導入模板數據已失效，請重新導入',
    all_type: '全部分類',
  ...
  userCenter: {
    ...
    api_key_desc:
      'API Key 是您存取 Crest API 的金鑰，具有帳戶的完全權限，請務必妥善保管！不要以任何方式公開API Key 到外部頻道，避免被他人利用造成安全威脅。 '
  },
  free: {
    title: '遊離資源管理',
    no_data: '暫無遊離資源',
