export default {
  common: {
    ...
    version_info_read_failed: 'Failed to read version information',
    exit_system: 'Log Out',
  ...
  data_set: {
    ...
    parameter_name: 'Parameter name',
    parameter_default_value_label: 'Parameter default value',
    ...
    export_tasks_successful_go_to: '{count} export tasks completed, go to',
    export_tasks_failed_go_to: '{count} export tasks failed, go to',
    data_set: 'Dataset',
    view: 'Chart',
    organization: 'Organization',
    download: 'Download',
    ...
    sql_content_required: 'SQL cannot be empty',
    ...
    expression_required: 'Expression cannot be empty!',
    copy_a_dataset: 'Copy dataset',
    related_field_required: 'Related field cannot be empty!',
    ...
    rule_condition_required: 'Rule condition cannot be empty'
  },
  data_source: {
    ...
    refresh_data: 'Refresh data',
    select_edit_table: 'Select data table',
    select_delete_rows: 'Select rows to delete',
    no_edit_changes: 'No changes to save',
    unsaved_edit_confirm: 'There are unsaved edits. Discard changes?',
    ...
    parameter_table_name_exists: 'Parameter table with the same name already exists',
    ...
    data_source_name_placeholder: 'Please enter the Datasource name',
    a_folder_name: 'Please enter the folder name',
    data_source: 'Datasource',
    the_destination_folder: 'Please select the destination folder',
    relevant_content_found: 'No relevant content found',
    cannot_be_empty: 'SSH host cannot be empty',
    ssh_port_required: 'SSH port cannot be empty',
    ssh_username_required: 'SSH username cannot be empty',
    ssh_password_required: 'SSH password cannot be empty',
    ssh_key_required: 'SSH key cannot be empty',
    to_64_characters: 'Parameter name limit 2 to 64 characters',
    interface_name_length_limit: 'Interface name limit 2 to 64 characters',
  ...
  system: {
    ...
    hour_execution_default: 'Hours (execution time: 0 minutes and 0 seconds)',
    ...
    upload_font_file_required: 'Please upload font file',
    font_name: 'Font name',
    font_file_label: 'Font file',
    ...
    url_format_error: 'URL format error, please re-enter',
    ...
    plugin_uninstall_restart_notice: 'Uninstall and restart the server to take effect',
  ...
  user: {
    ...
    pwd_pattern_error:
      '8-100 characters and at least one uppercase letter, lowercase letter, number, special character',
    ...
    current_user_status_locked: 'Current user status cannot be modified',
    ...
    data_import_failed_message: 'Data import failed'
  },
  userimport: {
  ...
  datasource: {
    ...
    kerbers_info:
      'Please make sure krb5.Conf, Keytab Key, have been added to the path: /opt/crest/conf',
  ...
  chart: {
    ...
    table_header_description: 'Header description',
    table_header_description_config: 'Description content',
    table_header_description_height: 'Description row height',
    table_header_description_tip:
      'Enter descriptions for visible fields. Hidden fields and order changes are matched by field.',
    table_header_description_placeholder: 'Enter description',
    ...
    merge_cells_fields: 'Merge fields',
    merge_cells_fields_placeholder: 'Select fields',
    merge_cells_fields_tip:
      'Only dimension fields before the first measure are available. Adjacent cells with the same value are merged vertically; lower-level dimensions are merged within the preceding dimension group.',
  ...
  dataset: {
    ...
    sql_variable_limit_2:
      "2. select * from table where $CREST_PARAM{'{'} name = substring('$[PARAM1]',1,5){'}'} and $CREST_PARAM{'{'} name in ($[PARAM2]) {'}'}",
  ...
  v_query: {
    ...
    required_default_value_empty:
      'The query condition is required and the default value cannot be empty',
  ...
  visualization: {
    ...
    outer_params_type_tips1:
      "When the type is 'filter', it only applies to text dropdown, text tree, and number dropdown. For text tree values, separate levels with ' > '.",
    outer_params_type_tips2:
      '["Level1","Level1 > Level2_1","Level2 > Level2_1","Level1 > Level2_1 > Level3_1","Level2"]',
    ...
    import_app_template: 'Import Application Template',
    template_file_type_limit: 'Only .crest template files are supported',
    template_type_mismatch: 'Template type does not match the current resource type',
    import_template_expired: 'Imported template data has expired. Please import it again',
  ...
  setting_basic: {
    ...
    initialPassword: 'Default password',
  ...
  sync_datasource: {
    ...
    passwd: 'Username and password',
    kerbers_info:
      'Please make sure krb5.Conf and Keytab Key have been added to the path: /opt/crest/conf',
    client_principal: 'Client Principal',
    keytab_Key_path: 'Keytab Key Path',
    data_base: 'Database name',
    user_name: 'Username',
