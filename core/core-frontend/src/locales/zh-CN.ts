export default {
  common: {
    ...
    backend_commit: '后端 Commit',
    version_info_read_failed: '版本信息读取失败',
    exit_system: '退出系统',
  ...
  data_set: {
    ...
    parameter_name: '参数名称',
    parameter_default_value_label: '参数默认值',
    ...
    export_tasks_successful_go_to: '{count} 个导出任务已成功，前往',
    export_tasks_failed_go_to: '{count} 个导出任务失败，前往',
    data_set: '数据集',
    view: '图表',
    organization: '所属组织',
    download: '下载',
    ...
    expression_required: '表达式不能为空!',
    copy_a_dataset: '复制数据集',
    related_field_required: '关联字段不能为空!',
    ...
    rule_condition_required: '规则条件不能为空'
  },
  data_source: {
    ...
    delete_row: '删除行',
    refresh_data: '刷新数据',
    select_edit_table: '请选择数据表',
    select_delete_rows: '请选择要删除的数据行',
    no_edit_changes: '暂无需要保存的改动',
    unsaved_edit_confirm: '当前编辑内容尚未保存，确认放弃改动？',
    ...
    parameter_table_name_exists: '已经存在同名的参数表',
    ...
    data_source_name_placeholder: '请输入数据源名称',
    a_folder_name: '请输入文件夹名称',
    data_source: '数据源',
    the_destination_folder: '请选择目标文件夹',
    relevant_content_found: '没有找到相关内容',
    cannot_be_empty: 'SSH主机不能为空',
    ssh_port_required: 'SSH端口不能为空',
    ssh_username_required: 'SSH用户名不能为空',
    ssh_password_required: 'SSH密码不能为空',
    ssh_key_required: 'SSH key不能为空',
    to_64_characters: '参数名称限制2～64字符',
    interface_name_length_limit: '接口名称限制2～64字符',
  ...
  system: {
    ...
    hour_execution_default: '小时（执行时间：0分0秒）',
    ...
    upload_font_file_required: '请上传字库文件',
    font_name: '字体名称',
    font_file_label: '字库文件',
    ...
    mobile_supports_custom_settings: '默认为 {msg} 移动端登录界面，支持自定义设置',
    login_logo: '登录 Logo',
    ...
    url_format_error: 'url格式错误，请重新输入',
    ...
    plugin_uninstall_restart_notice: '卸载并重启服务器之后才能生效',
  ...
  user: {
    ...
    pwd_pattern_error: '8-100位且至少一位大写字母、小写字母、数字、特殊字符',
    ...
    current_user_status_locked: '不能修改当前用户状态',
    ...
    data_import_failed_message: '数据导入失败'
  },
  userimport: {
    buttonText: '批量导入',
    dialogTitle: '批量上传',
  ...
  datasource: {
    ...
    auth_method: '认证方式',
    passwd: '用户名密码',
    kerbers_info: '请确保 krb5.Conf、Keytab Key，已经添加到路径：/opt/crest/conf',
  ...
  chart: {
    ...
    table_header_description: '表头说明',
    table_header_description_config: '说明内容',
    table_header_description_height: '说明行高',
    table_header_description_tip:
      '按当前显示字段填写说明；字段隐藏或调整顺序后，会按字段重新匹配。',
    table_header_description_placeholder: '请输入说明内容',
    cancel_group: '取消分组',
    ...
    merge_cells: '合并单元格',
    merge_cells_fields: '合并字段',
    merge_cells_fields_placeholder: '请选择字段',
    merge_cells_fields_tip:
      '仅支持选择第一个指标前的维度字段；系统会按上下相邻且值相同的单元格纵向合并，后置维度会在前置维度分组内合并。',
    length_limit: '长度限制',
    radar_point: '开启辅助点',
  ...
  dataset: {
    ...
    sql_variable_limit_2:
      "2、示例: select * from table where $CREST_PARAM{'{'} name = substring('$[PARAM1]',1,5){'}'} and $CREST_PARAM{'{'} name in ($[PARAM2]) {'}'}",
    select_month: '选择月',
    select_date: '选择日期',
    select_time: '选择时间',
    time_year: '日期-年',
  ...
  v_query: {
    ...
    required_default_value_empty: '查询条件为必填项,默认值不能为空',
  ...
  visualization: {
    ...
    outer_params_type_tips1:
      "类型为过滤时，仅支持文本下拉、文本树、数字下拉；文本树多级值使用 ' > ' 分隔。",
    ...
    apply_template: '应用模板',
    style_template: '样式模板',
    import_app_template: '导入应用模板',
    template_file_type_limit: '仅支持 .crest 模板文件',
    template_type_mismatch: '模板类型与当前资源类型不一致',
    import_template_expired: '导入模板数据已失效，请重新导入',
    all_type: '全部分类',
