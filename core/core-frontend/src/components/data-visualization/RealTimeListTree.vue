        ...
        >
          <template #item="{ index }">
            <div>
              ...
              >
                <div
                  v-show="['Group', 'Tabs'].includes(getComponent(index)?.component)"
                  style="width: 22px"
                >
                  <el-icon
              ...
              <div v-if="getComponent(index)?.component === 'Tabs' && getComponent(index)?.expand">
                <real-time-tab
